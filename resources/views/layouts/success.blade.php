...
<head>
    ...
    <link href="webicosoft-assets/pages/css/login-5.min.css" rel="stylesheet">
    ...
    <div class="row bs-reset">
        ...
        <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
            <div class="login-5-top col-sm-12">
                ...
                <a href="{{config('constants.base_url')}}/login" class="btn pull-right">Login</a>

                <a href="{{config('constants.base_url')}}" class="btn pull-right">Get started - it's free!</a>
            </div>
            <div class="login-content">

                <div class="note">
                    <h4 class="block font-green">Success !</h4>
                    <p> A confirmation email has been sent to your mailbox <b>{{session()->get('email')}}</b> </p><br>
                    <p> Please check your mailbox and continue your account creation.</p>
                </div>
            </div>
